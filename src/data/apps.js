...
export const apps_data = [
  {
    id: 0,
    name: "OpenFlow",
    title: "Open Analytics Automation Workflow",
    ...
    app_url: "https://github.com/stephensanwo/openflow-client",
    repo_url: "https://github.com/stephensanwo/openflow-client",
...

  {
    ...
    logo: <CloudComputing fill="#000" width="48px" height="48px" />,
  ...
  },
  {
    ...
    logo: <Robot fill="#000" width="48px" height="48px" />,
  ...
  },
  {
    ...
    logo: <Globe fill="#000" width="48px" height="48px" />,
    built_with: ["Python", "OpenCV", "GraphQL", "NodeJs", "React", "MongoDB"],
    app_url: "",
    repo_url: "",
    category: ["AI and ML Apps", "Web Apps"],
...

  {
    ...
    logo: <Desktop fill="#000" width="48px" height="48px" />,
  ...
  },
  {
    ...
    logo: <Network fill="#000" width="48px" height="48px" />,
...
export const app_categories_small = [
  ...
  { id: 3, title: "Web Apps", logo: <Wikis16 fill="#addec9" /> },
  {
    id: 4,
    title: "Mobile Apps",
