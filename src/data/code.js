...
export const code_categories_small = [
  ...
  { id: 3, title: "Tensorflow", logo: <Code16 fill="#986ee2" /> },
  {
    id: 4,
    title: "Redis",
    logo: <Code16 fill="#986ee2" />,
  ...
  { id: 6, title: "MongoDB", logo: <DataBase16 fill="#986ee2" /> },
  { id: 7, title: "SQL", logo: <Sql16 fill="#986ee2" /> },
  {
    id: 8,
    title: "React",
    logo: <Code16 fill="#986ee2" />,
